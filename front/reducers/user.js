  ...
  return produce(state, draft => {
    switch (action.type) {
      ...
      case LOG_OUT_REQUEST:
        ...
        draft.logOutError = null; // Done을 왜 굳이 초기화 해야하지?
        break;
      ...
      case SIGN_UP_REQUEST:
        ...
        draft.signUpError = null; // Done을 왜 굳이 초기화 해야하지?
        break;
      ...
      case CHANGE_NICKNAME_REQUEST:
        ...
        draft.changeNicknameError = null; // Done을 왜 굳이 초기화 해야하지?
        break;
      ...
      case CHANGE_NICKNAME_FAILURE:
        draft.changeNicknameLoading = false;
        draft.changeNicknameError = action.data.error;
        break;
      case ADD_POST_TO_ME:
